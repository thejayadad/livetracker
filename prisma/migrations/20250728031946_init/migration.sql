...
-- CreateIndex
CREATE INDEX "Habit_userEmail_idx" ON "Habit"("userEmail");
...
-- AddForeignKey
ALTER TABLE "Habit" ADD CONSTRAINT "Habit_userEmail_fkey" FOREIGN KEY ("userEmail") REFERENCES "User"("email") ON DELETE CASCADE ON UPDATE CASCADE;
